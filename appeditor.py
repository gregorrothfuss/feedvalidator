...
class MyFrame1(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        for ws in self.load_service_list():
    ...
    def load_service_list(self):
        ...
        for service in config.sections():
            ...
            if config.has_option(service, 'name'):
                ...
                name = password = None
            service_list.append(atompub.Service(uri, CACHE_DIR, name, password))
        return sum([service.workspaces() for service in service_list], [])
    ...
    def update_entry_list(self, fresh):
        ...
        if self.current_collection:
            for e in self.current_collection.iter_entries():
