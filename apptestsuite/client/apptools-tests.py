...
class unparseAtomEntryTest(unittest.TestCase):
    ...
    def testEntry(self):
        ...
        d = apptools.parse_atom_entry(".", new_text)
        self.assertEqual("This is text", d['content'])
        self.assertEqual('<p>This is text</p>', d['summary'])
